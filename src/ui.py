...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
            MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"KANGAL PUBG Mobile Tool", None))
            ...
            self.about_label_text.setText(QCoreApplication.translate("MainWindow",
                                                                     u"<h2>Optimize Your PUBG Mobile Experience with KANGAL PUBG Mobile Tool</h2>\n"
                                                                     "\n"
                                                                     "                                <h3>Features:</h3>\n"
                                                                     "                                <ul>\n"
                                                                     ...
                                                                     "                                </center>\n"
                                                                     "                            ", None))
            self.appname_label.setText(QCoreApplication.translate("MainWindow", u"KANGAL PUBG Mobile Tool v1.0.0", None))
